...
<head>
	...
	<link href="<?php echo base_url('sourse/css/editor.css');?>"rel="stylesheet"/>
	...
	<script src="<?php echo base_url('sourse/js/editor.js');?>"></script>
...
<body class="container-fluid">
	<div id=""class="navbar navbar-inverse">
		<!--导航栏-->
		...
		<ul id="bs-example-navbar-collapse-1"class="nav navbar-nav navbar-right container-fluid collapse navbar-collapse">
			<li id=""class=""><a href="#"><span id="hook-add-blog" data-toggle="modal" data-target="" class="glyphicon glyphicon-plus-sign"></span></a></li>
	...
	<div id=""class="row"style="margin-top:55px;">
		...
		<div class="panel panel-default col-sm-6">
		  ...
		  <div class="panel-body">
			<form class="form-horizontal"action="<?php echo base_url('index.php/welcome/doAddBlog');?>"method="post">
				  <div class="form-group">
					<label for="linkname" class="control-label sr-only">博客标题</label>
					<div class="col-sm-12">
					  <input type="text" class="form-control" id="linkname"name="linkname" value="<?php if(isset($title)){$title;};?>"placeholder="写个标题">
					</div>
				  </div>
				  <div class="form-group">
					<label for="content" class="control-label sr-only">博客内容</label>
					<div class="col-sm-12">
						<textarea id="content"name="content"class="form-control"rows="8"placeholder="写点内容..."value="<?php if(isset($content)){echo $content;};?>"></textarea>
					</div>
				  </div>
				  <button id="hock_submit"class="btn btn-default">提交</button>
				</form>
		  </div>
		</div>
